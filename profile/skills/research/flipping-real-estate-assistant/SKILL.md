...
- **Visual inspection & budget levers on Khrushchev/Brezhnevka flips (learned on Фрунзе 17):**
  ...
  - **Sewer riser shaft & compact bathroom ergonomics (2.9 m² Khrushchev 1-447 standard):**
    - *Rough niche dimensions:* Typical corner niche / riser zone is **400–600 mm wide × 250–350 mm deep** (accommodates 110 mm PVC stack, tee, cold/hot water risers, ball valves, and water meters).
    - *Finished drywall box (GKLV + tile):* Minimum aesthetic box is **300 × 300 mm** (pipe-only) or **500–600 mm wide × 200–250 mm deep** when combined with an in-wall toilet cistern frame (инсталляция). Creating a half-height ledge (~115–120 cm high) yields a practical 15–20 cm shelf above the toilet and visually unifies the wall plane.
    - *Sanitary fixture clearances & selection in 1500 × 1900 mm bathrooms:*
      - **Bathtub:** strictly 1500 × 700 mm along the short wall; ensure rough masonry span is $\ge$ 1505 mm so the tub installs tight wall-to-wall without shaving studs.
      - **Toilet:** compact wall-hung bowl (480–490 mm length; ~680–710 mm total projection including frame box) or compact floor toilet ($\le$ 600 mm). Maintain $\ge$ 500–600 mm legroom in front of the bowl and $\ge$ 350 mm from center axis to adjacent wall/vanity.
      - **Vanity / Sink:** 500–600 mm width (380–450 mm depth) to prevent knee crowding with the toilet.
      - **Inspection access:** minimum 400 × 600 mm concealed push-open tile hatch or removable panel for unobstructed meter reading and drain snake access.
  - **Subfloor screed mix in bathrooms (M300 vs M150 & quantity calculation):**
    - *Material grade:* Always specify **coarse sand concrete M300 (пескобетон М300)** rather than masonry/plaster mix M150. M150 uses fine sand (0.8–1.2 mm), requires excess gauging water, suffers severe drying shrinkage (crazing/hollow sounding), and has low compressive strength (15 MPa vs 30 MPa for M300) which risks debonding under high-adhesion tile adhesives (C1/C2). The cost difference is negligible (~150 ₽ on the entire room).
    - *Bag quantity estimation formula (40 kg bags):* For typical 2.5–2.9 m² bathroom slab:
      - 30–50 mm layer (avg 40 mm, ~1.8–2.0 m² net open floor excluding tub): **5–6 bags** (40 kg).
      - 50–70 mm layer (avg 60 mm): **7 bags** (40 kg).
      - Always pair with 10 mm screed guides (2 pcs), polypropylene fiber (100–150 g/batch to eliminate shrinkage cracks), and perimeter foam expansion tape (100 mm). Mix to a stiff semi-dry "damp earth" consistency to prevent any liquid seepage through precast hollow-core slab sleeves to lower floors.
...
- **Financial tracking & Expense benchmarking (Google Sheets + Excel):**
  ...
  - **Financial documents & Receipt OCR (Strict Rule):** NEVER use free (`:free`) or low-parameter vision models to parse receipts, invoices, or financial tables. Hallucinations in digits/item lines corrupt the budget. Use only high-accuracy vision models (Gemini Flash / GPT-4o) and always enforce programmatic verification of line items: $\sum (\text{Qty} \times \text{Price}) == \text{Total}$ before updating financial ledgers.

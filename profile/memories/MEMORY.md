Проекты по приоритету: 1) недвижимость (главный): флиппинг, цикл 2 мес; 2) WB кружки: расширить тематику принтов; 3) Divine Element: перезапуск. График не нормирован — приоритеты и контекст активных проектов сверять в начале работы.
§
...
§
Модели OpenRouter: основа gemini-3.7-flash (fallback deepseek-v4-flash-vision-exp, deepseek-v4-flash); vision gemini-3.7-flash (резерв deepseek vision exp); image_gen gemini-3.1-flash-image; хелперы deepseek flash. Главное — ум.
§
